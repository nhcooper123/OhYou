...
%In the light of the results below, some properties of this model are worth highlighting. When $\alpha$ is small, evolution is approximately Brownian, then as $\alpha$ gets larger the non-Brownian behaviour of the model starts to become apparent. Eventually, when $\alpha$ is really large, all imprint of history is lost and the evolution is essentially a rapid burst at the present (Fig. \ref{figure.traitsim}C). This will be indistinguishable from phylogenetically unstructured data.  
